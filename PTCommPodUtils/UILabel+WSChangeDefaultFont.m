//
//  UILabel+WSChangeDefaultFont.m
//  MumMum-Seller
//
//  Created by shlity on 16/9/21.
//  Copyright © 2016年 Moresing Inc. All rights reserved.
//

#import "UILabel+WSChangeDefaultFont.h"
#import <objc/runtime.h>

@implementation UILabel (WSChangeDefaultFont)
/**
...
{
    id __self = [self YHBaseInit];//PingFangSC-Light
    UIFont * font = [UIFont fontWithName:@".PingFang-SC-Light" size:self.font.pointSize];
    if (font) {
        self.font=font;
    }
    return __self;
